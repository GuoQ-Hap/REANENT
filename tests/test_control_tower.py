...
class ControlTowerTests(unittest.TestCase):
    ...
    def test_monthly_forecast_review_compares_weekly_forecast_from_snapshot_to_previous_day(self):
        connector = FakeMainRuleConnector()
        ...
        self.assertEqual(review.comparison_start_date, "2026-04-11")
        self.assertEqual(review.comparison_end_date, "2026-06-09")
        self.assertEqual(review.review_start_date, "2026-04-11")
        self.assertEqual(review.review_end_date, "2026-06-09")
        ...
        self.assertEqual(review.forecast_quantity, 542)
        self.assertEqual(review.actual_sales, 650.4)
        self.assertEqual(review.difference, 108.4)
        ...
        self.assertEqual(review.forecast_row_count, 9)
        self.assertEqual(review.actual_row_count, 9)
        self.assertEqual(len(review.weekly_estimates), 9)
        first_week = review.weekly_estimates[0]
        self.assertEqual(first_week.week, "2026W15")
        self.assertEqual(first_week.week_start_date, "2026-04-11")
        self.assertEqual(first_week.week_end_date, "2026-04-12")
        self.assertEqual(first_week.forecast_quantity, 10)
        self.assertEqual(first_week.actual_sales, 12)
        self.assertEqual(first_week.difference, 2)
